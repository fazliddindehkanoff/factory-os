...
| **procurement_head / procurement_manager** | Главная · Заявки · **Закупки** (Очередь + Поставщики) · (Согласования) · Меню | заявки в закупке / КП | Очередь закупок, Поставщики CRUD, Добавить КП (выбор поставщика из справочника), Выбрать поставщика (+ warning при одном КП) | mark paid, склад-issue, Админ | «Снабжение подбирает поставщика» |
