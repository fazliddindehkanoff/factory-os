...
export const api = {
  ...
  requestAction: (
    id: string,
    body: { action: string; pin?: string; comment?: string; amount?: number; supplierName?: string; supplierId?: string; ndsIncluded?: boolean; paymentType?: string; quoteItems?: { itemId: string; unitPrice: number; supplierName?: string; supplierId?: string | null; ndsIncluded?: boolean; paymentType?: string | null }[]; leadTime?: string; quotationId?: string; receipts?: { itemId: string; receivedQty: number }[] },
